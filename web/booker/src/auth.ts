...
const authority = import.meta.env.VITE_OIDC_AUTHORITY ?? "http://localhost:8180/realms/yadori-booker";
const clientId = import.meta.env.VITE_OIDC_CLIENT_ID ?? "yadori-booker-web";
